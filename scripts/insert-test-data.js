...
async function insertTestData() {
  ...
  else console.log('  ✅ Dupont Jean - 850€ (4 days)')
  ...
  else console.log('  ✅ Martin Sophie - 2100€ (6 days)')
  ...
  else console.log('  ✅ Bernard Paul - 1450€ (8 days)')
  ...
  else console.log('  ✅ Rousseau Marie - 620€ (2 days)')
  ...
  else console.log('  ✅ Garcia Maria - 2450€ (Sunday)')
  ...
  console.log('  • calcul-ca: 4400€ total for week (Leroy + Garcia)')
}
