...
const agentsDetail = [
  {
    ...
    report: "J'ai relancé 12 clients qui n'avaient pas répondu à leur devis. 3 m'ont déjà rappelé.",
    stat1: { value: '147', label: 'devis relancés ce mois', color: '#23211D' },
    stat2: { value: '+125 000 €', label: 'récupérés', color: '#157347' },
    activity: [
      { time: 'Auj. 14:02', text: 'Relance envoyée à M. Dupont' },
      { time: 'Auj. 09:15', text: '4 relances groupées' },
      { time: 'Hier 20:00', text: '8 devis relancés' },
    ],
  ...
  },
  {
    ...
    status: 'actif' as const,
    statusLabel: 'Au travail',
    report: "Ce matin je vous ai préparé le résumé de la journée : 8 chantiers à suivre, rien d'urgent.",
    stat1: { value: '184', label: 'résumés livrés', color: '#23211D' },
  ...
  },
  {
    ...
    status: 'actif' as const,
    statusLabel: 'Au travail',
    report: "J'ai repéré 3 devis qui traînaient depuis trop longtemps et je vous les ai signalés avant qu'ils ne soient perdus.",
    stat1: { value: '23', label: 'devis sauvés à temps', color: '#23211D' },
    stat2: { value: '+58 000 €', label: 'évités de perdre', color: '#157347' },
    activity: [
      { time: 'Auj. 13:40', text: 'Alerte : devis #1247 (J+7)' },
      { time: 'Auj. 07:40', text: 'Aucun devis critique' },
      { time: 'Hier 19:40', text: 'Alerte : devis #1198 (J+8)' },
    ],
    buttonText: 'Mettre en pause',
    buttonStyle: 'default' as const,
  },
  {
    ...
    status: 'actif' as const,
    statusLabel: 'Au travail',
    report: "J'ai demandé un avis à 5 clients satisfaits. 2 vous ont déjà mis 5 étoiles sur Google.",
    stat1: { value: '67', label: 'avis Google récoltés', color: '#23211D' },
    stat2: { value: '4,8 ★', label: 'note moyenne', color: '#23211D' },
    activity: [
      { time: 'Auj. 09:00', text: "5 demandes d'avis envoyées" },
      { time: 'Hier', text: '2 nouveaux avis 5★ reçus' },
      { time: 'Avant-hier', text: '6 demandes envoyées' },
    ],
    buttonText: 'Mettre en pause',
    buttonStyle: 'default' as const,
  },
  {
    ...
    stat1: { value: '256 000 €', label: 'prévus ce mois', color: '#157347' },
    stat2: { value: '12', label: 'rapports envoyés', color: '#23211D' },
    activity: [
      { time: 'Lundi 08:00', text: 'CA hebdo calculé : 256 000 €' },
      { time: 'Lun. préc.', text: 'CA hebdo : 238 000 €' },
  ...
  },
  {
    ...
    stat1: { value: '+8 %', label: 'marge moyenne', color: '#157347' },
    stat2: { value: '42', label: 'chantiers analysés', color: '#23211D' },
    activity: [
      { time: 'Auj. 21:00', text: '❌ Échec connexion API' },
      { time: 'Hier 21:00', text: 'Marges calculées : +8%' },
      { time: 'Avant-hier', text: 'Marges calculées : +7%' },
    ],
