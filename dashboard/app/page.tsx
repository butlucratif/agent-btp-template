  ...
  const agentCards = [
    {
      ...
      stat1: { value: '147', label: 'devis relancés ce mois' },
      stat2: { value: '+125 000 €', label: 'récupérés', isMoney: true },
    ...
    },
    {
      ...
      stat1: { value: '184', label: 'résumés livrés' },
    ...
    },
    {
      ...
      stat1: { value: '23', label: 'devis sauvés à temps' },
      stat2: { value: '+58 000 €', label: 'évités de perdre', isMoney: true },
    ...
    },
    {
      ...
      stat1: { value: '67', label: 'avis Google récoltés' },
      stat2: { value: '4,8 ★', label: 'note moyenne' },
    ...
    },
    {
      ...
      stat1: { value: '256 000 €', label: 'prévus ce mois', isMoney: true },
      stat2: { value: '12', label: 'rapports envoyés' },
    ...
    },
    {
      ...
      stat1: { value: '+8 %', label: 'marge moyenne' },
      stat2: { value: '42', label: 'chantiers analysés' },
